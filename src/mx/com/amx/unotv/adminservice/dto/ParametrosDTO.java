...
public class ParametrosDTO implements Serializable {
	...
	/**
	 * @param carpetaResources
	 *            the carpetaResources to set
	 */
	...
	/**
	 * @param basePaginaPlantilla
	 *            the basePaginaPlantilla to set
	 */
	...
	/**
	 * @param basePagesPortal
	 *            the basePagesPortal to set
	 */
	...
	/**
	 * @param metaVideoSecureUrl
	 *            the metaVideoSecureUrl to set
	 */
	...
	/**
	 * @param pathRemoteTest
	 *            the pathRemoteTest to set
	 */
	...
	/**
	 * @param uRL_WS_PARAMETROS
	 *            the uRL_WS_PARAMETROS to set
	 */
	...
	/**
	 * @param uRL_WEBSERVER_AMP
	 *            the uRL_WEBSERVER_AMP to set
	 */
	...
	/**
	 * @param uRL_WEBSERVER_CSS_AMP
	 *            the uRL_WEBSERVER_CSS_AMP to set
	 */
	...
	public void setMet_wsb_FB_insertUpdateArticle2(String met_wsb_FB_insertUpdateArticle2) {
	...
	public void setMet_wsb_BackOffice_sendPushAMP(String met_wsb_BackOffice_sendPushAMP) {
	...
	public void setMet_wsb_WorkFlowUtils_getInfoVideo(String met_wsb_WorkFlowUtils_getInfoVideo) {
	...
	public void setMet_wsd_WorkFlow_existeNotaRegistrada(String met_wsd_WorkFlow_existeNotaRegistrada) {
	...
	public void setMet_wsd_WorkFlow_getIdNotaByName(String met_wsd_WorkFlow_getIdNotaByName) {
	...
	public void setMet_wsd_WorkFlow_insertNotaTag(String met_wsd_WorkFlow_insertNotaTag) {
	...
	public void setMet_wsd_WorkFlow_deleteNotaTag(String met_wsd_WorkFlow_deleteNotaTag) {
	...
	public void setMet_wsd_WorkFlow_deleteNotaBD(String met_wsd_WorkFlow_deleteNotaBD) {
	...
	public void setMet_wsd_WorkFlow_deleteNotaHistoricoBD(String met_wsd_WorkFlow_deleteNotaHistoricoBD) {
	...
	public void setMet_wsd_WorkFlow_getNotasMagazine(String met_wsd_WorkFlow_getNotasMagazine) {
	...
	public void setMet_wsd_WorkFlow_getRelacionadasbyIdCategoria(String met_wsd_WorkFlow_getRelacionadasbyIdCategoria) {
	...
	public void setMet_wsd_WorkFlow_insertNotaBD(String met_wsd_WorkFlow_insertNotaBD) {
	...
	public void setMet_wsd_WorkFlow_insertNotaHistoricoBD(String met_wsd_WorkFlow_insertNotaHistoricoBD) {
	...
	public void setMet_wsd_WorkFlow_updateNotaBD(String met_wsd_WorkFlow_updateNotaBD) {
	...
	public void setMet_wsd_WorkFlow_updateNotaHistoricoBD(String met_wsd_WorkFlow_updateNotaHistoricoBD) {
	...
	public void setMet_wsd_WorkFlow_getExtraInfoContent(String met_wsd_WorkFlow_getExtraInfoContent) {
